...
var (
	...
	QueryCreateIdP = dbmodel.DBQuery{
		ID:    "IPQ-IDP_MGT-01",
		Query: "INSERT INTO \"IDP\" (IDP_ID, NAME, DESCRIPTION, CLIENT_ID, CLIENT_SECRET, REDIRECT_URI, SCOPES) VALUES ($1, $2, $3, $4, $5, $6, $7)",
	}

	// QueryGetIdPByIdPID is the query to get a IdP by IdP ID.
	QueryGetIdPByIdPID = dbmodel.DBQuery{
		ID:    "IPQ-IDP_MGT-02",
		Query: "SELECT IDP_ID, NAME, DESCRIPTION, CLIENT_ID, CLIENT_SECRET, REDIRECT_URI, SCOPES FROM \"IDP\" WHERE IDP_ID = $1",
	}
	...
	QueryUpdateIdPByIdPID = dbmodel.DBQuery{
		ID:    "IPQ-IDP_MGT-04",
		Query: "UPDATE \"IDP\" SET NAME = $2, DESCRIPTION = $3, CLIENT_ID = $4, CLIENT_SECRET = $5, REDIRECT_URI = $6, SCOPES = $7 WHERE IDP_ID = $1;",
	}
